					...
					<div class="blog-post-area-list" id="post-meta">
						...
						<div class="single-blog-post-list">
							<c:forEach items="${faqList }" var="vo">
								<h3>
									<b><a href="../blog/faqDetail.do?faq_seq=${vo.faq_seq}">${vo.faq_title}</a></b>
								</h3>
								<div class="post-meta">
									<ul>
										<li><i class="fa fa-user"></i><a
											href="../blog/faqDetail.do?faq_seq=${vo.faq_seq}">${vo.faq_tag1}</a></li>
										<li><i class="fa fa-user"></i><a
											href="../blog/faqDetail.do?faq_seq=${vo.faq_seq}">${vo.faq_tag2}</a></li>
										<li><i class="fa fa-user"></i><a
											href="../blog/faqDetail.do?faq_seq=${vo.faq_seq}">${vo.faq_tag3}</a></li>
									</ul>
								...
								<c:if test="${vo.faq_name!=null}">
									<a href="../blog/faqDetail.do?faq_seq=${vo.faq_seq}"><img
										src="<%=pjName %>/resources/images/${vo.faq_realname}"
										width="20%" height="auto"></a>
