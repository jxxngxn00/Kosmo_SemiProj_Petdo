...
<body>
	...
	<section>
		...
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="food-shop.do" style="font-weight: bold; letter-spacing: 3px; font-size: 16px;" class="button">식품                
		</li>
