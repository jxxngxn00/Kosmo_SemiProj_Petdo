					...
					<form action="return.do">
						<table id="detailTbl">
							<tr>
								...
								<td><input name="" type="text" value="${userOrder.order_number }" readonly/></td>
							</tr>
							<tr>
								<th scope="row">상품명</th>
								<td><input name="" type="text"  value="${userOrder.product_name }" readonly/></td>
							</tr>
							<tr>
								<th scope="row">주문날짜</th>
								<td><input name="" type="text"  value="${userOrder.order_date }" readonly/></td>
							</tr>
							<tr>
								<th scope="row">배송상태</th>
								<td><input name="" type="text" value="${userOrder.order_detail_status }"  readonly/></td>
							</tr>
							<tr>
								<th scope="row">구매자</th>
								<td><input name="" type="text"  value="${userOrder.user_name }" readonly/></td>
							</tr>
							<tr>
								<th scope="row">결제금액</th>
								<td><input name="" type="text" value="${userOrder.product_price }"  readonly/></td>
							</tr>
						</table>
