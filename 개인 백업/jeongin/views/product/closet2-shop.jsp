...
<body>
	...
	<section>
		...
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="closet-shop.do" style="font-weight: bold; font-size: 16px; letter-spacing: 3px;" class="button">의류             
		</li>
