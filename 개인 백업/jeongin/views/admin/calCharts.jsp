				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="faq.do">FAQ 관리</a> <a
							class="collapse-item" href="review.do">리뷰 관리</a> <a
						...
						<div class="collapse show" id="collapseCardExample"
							style="text-align: center;">
								<div class="card-body" id="datePickerBody">
									<span class="date-picker"><input type="date"
										name="start_date" /></span> <span class="date-picker">~</span> <span
										class="date-picker"><input type="date" name="end_date" /></span>
								</div>
