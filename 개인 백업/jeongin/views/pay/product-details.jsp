	...
	<section>
		<div class="container" style="width: 70%">
			...
			<div class="row productInfo" style="width: 40%; float: right;">
				...
				<input type="hidden" name="stored_main_file_name"  value="${getProduct.stored_main_file_name}"/>
...
<div class="container">
		...
		<div id="product-info" class="row about_product" style="text-align: center;">
			<img src='<%=pjName%>/resources/images/product-details/${getProduct.stored_main_file_name}'  name="stored_main_file_name" width=100%; height=auto;>
		</div>
