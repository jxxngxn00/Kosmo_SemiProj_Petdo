...
<head>
    ...
    <title>food-shop.html</title>
     <% String pjName="/petdo"; %>
     <link href="<%=pjName %>/resources/<%=pjName %>/resources/mCss/bootstrap.min.css" rel="stylesheet">
	...
	<header id="header"><!--header-->
			...
			<div class="container">
				<div class="header-middle"><!--header-middle-->
					<a href="main.html"><img src="images/home/petdologo.png" width="20%" height="auto"" id="petlogo" alt="" /></a>
							<div class="col-sm-8">
					...
					<div id="sm-9" class="col-sm-9">
						...
						<div class="mainmenu pull-left ">
							<ul class="nav navbar-nav collapse navbar-collapse" style="font-size: 0;">
								...
								<li><a href="living-shop.html" style="color: #FF9933;">NOTICE</a></li> 
								<li><a href="living-shop.html" style="color: #FF9933;" >FAQ</a></li>
								<li><a href="living-shop.html" style="color: #FF9933;" >Q&A</a></li>
							</ul>
						</div>
