...
<body>
	...
	<section>
		...
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="closet-shop.do" class="button" style="font-weight: bold; font-size: 16px;">의류
		</li>
					...
					<div class="features_items"><!--features_items-->
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										< src="<%=pjName %>/resources/images/shop/019_브레드 베어 윈디 점퍼_2.jpg" alt="" />
										<p style="margin-top: 6px;">테디 블라썸 져지</p>
											<strong class="product_price"
												<span style="font-size: 16px; color: #000000;">42,000원 &nbsp;</span>
											</strong>
