					...
					<div class="mainmenu pull-left ">
						...
						<div class="search_box pull-right">
							<input type="text" placeholder="검색"/>
								<a href="product/searchpage.do" style="margin-left: 140px; margin-top:9px; position: absolute;"><i class="fa-sharp fa-solid fa-magnifying-glass" style="color: black;"></i></a>
						</div>
    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    		
					...
					<br/>
					<br/>   			
					<h2 class="title text-center" style="margin-bottom: 80px; font-size: 45px; font-family: 'Noto Sans KR', sans-serif;">PROFILE</h2>    			    				    				
	    			...
	    			<div class="contact-form">
	    				<hr/>
							...
							<div class="form-group col-md-12">
								...
								<input type="text" readonly="readonly" name="subject" class="form-control" required="required"  style="width: 40%; margin-left: 115px;">
							</div>
							<div class="form-group col-md-12">
								<p id="customerEmail" style="float: left; margin-top: 6px; font-family: 'Noto Sans KR', sans-serif;">이름</p>
				                <input type="text" name="subject" readonly="readonly" class="form-control" required="required"  style="width: 40%; margin-left: 115px;">
				            </div>
				            <div class="form-group col-md-12">
								<p id="customerEmail" style="float: left; font-family: 'Noto Sans KR', sans-serif; margin-top: 6px" >E-Mail</p>
				                <input type="text" name="subject" readonly="readonly" class="form-control" required="required" style="width: 83%; margin-left: 115px;">
				            </div>
							<div class="form-group col-md-12">
								<p id="customerEmail" style="float: left; font-family: 'Noto Sans KR', sans-serif; margin-top: 6px;">성별</p>
				                <input type="text" name="subject" readonly="readonly" class="form-control" required="required"  style="width: 20%; margin-left: 115px;">
				            </div>
							<div class="form-group col-md-12">
							...
							<div class="form-group col-md-12" style="display: f;">
								...
								<div>
				                <input type="text" name="subject" class="form-control" readonly="readonly" required="required" style="width: 20%; margin-left: 89px; display: inline;" >
								<input type="text" name="subject" class="form-control" readonly="readonly" required="required" style="width: 83%; margin-left: 115px; margin-top: 5px;">
								</div>
								<hr/>
				            </div>
	    				...
	    				<p class="title text-center" id="fonttitle"  style="text-transform: capitalize; font-family: 'Noto Sans KR', sans-serif;">My Account</p>
							...
							<ul>
								<li style="margin-left: -38px; ">
									...
									<a href="../logOut.do" style="font-family: 'Noto Sans KR', sans-serif;">로그아웃</a><br/><br/><br/>
								</li>
