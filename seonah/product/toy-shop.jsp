...
<body>
	...
	<section>
		...
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="toy-shop.do" style="font-weight: bold; letter-spacing: 3px; font-size: 16px;" class="button">장난감                
		</li>
