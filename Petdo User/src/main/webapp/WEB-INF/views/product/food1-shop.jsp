...
<body>
	...
	<section>
		...
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="food-shop.do" class="button" style="font-weight: bold; font-size: 16px;">식품                
		</li>
									...
									<div class="productinfo text-center">
										...
										<a href="cart.do" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i></a>
											...
											<div style="margin-left: 13px;">
												...
												< src="<%=pjName %>/resources/images/home/NEW.JPG" id="new" style="margin-top: -42px;" width="2px" height="auto" alt=""/>
											</div>	
									</div>
								</div>
							</div>
