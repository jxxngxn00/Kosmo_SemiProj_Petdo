...
<body>
	<header id="header"><!--header-->
		...
		<div class="container">
			<div class="header-middle"><!--header-middle-->
				<a href="../main.do"><img src="images/home/petdologo.png" width="12%" height="auto"" id="petlogo" alt="" /></a>
						<div class="col-sm-8">
	...
	<section>
		...
		<img src="images/home/subbanner_1.png" id='subbaner' width="100%" height="auto" alt="" />		
	
		<div class="ec-base-tab typeMenu">
			<ul class="menuCategory menu clearfix">
		<hr/>
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="/category/목욕/60/" class="button">케어                
		</li>
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="/category/피부관리/61/" class="button">배변/위생                
		</li>
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="/category/구강관리/62/" class="button">장난감                
		</li>
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="/category/건강관리/67/" class="button">식품                
		</li>
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="/category/배변위생/63/" class="button">홈/리빙               
		</li>
		<li style="display:inline-block;" class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a href="/category/훈련/69/" class="button">의류                
		</li>
							...
							<div class="col-sm-4" id="col-sm-4">
								<div class="productinfo text-center">
									<div class="product-image-wrapper">
										...
										<img src="images/home/20_테디 블라썸 져지_2.jpg" alt=""/>
										<p>테디 블라썸 져지</p>
												...
												<img src="images/home/BEST.JPG" id="new" width="2px" height="auto" alt=""/>
												<img src="images/home/NEW.JPG" id="new" width="2px" height="auto" alt=""/>
										</div>
									</div>
								</div>	
							</div>
								...
								<div class="productinfo text-center">
									<div class="product-image-wrapper">
										...
										<p>테디 블라썸 져지</p>
												...
												<img src="images/home/BEST.JPG" id="new" width="2px" height="auto" alt=""/><img src="images/home/NEW.JPG" id="new" width="2px" height="auto" alt=""/>
												<img src="images/home/NEW.JPG" id="new" width="2px" height="auto" alt=""/>
										</div>
									</div>
								</div>	
