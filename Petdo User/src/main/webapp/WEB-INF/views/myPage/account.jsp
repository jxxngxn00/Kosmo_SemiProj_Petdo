	...
	<header id="header"><!--header-->
			...
			<div class="container">
				<div class="header-middle"><!--header-middle-->
					<a href="../main.do"><img src="<%=pjName %>/resources/images/home/logo.png" width="20%" height="auto" id="petlogo" alt="" /></a>
							<div class="col-sm-8">
